...
export function getClientDateTimeString() {
    ...
    return clientTime.getFullYear() + '-' +
        String(clientTime.getMonth() + 1).padStart(2, '0') + '-' +
        String(clientTime.getDate()).padStart(2, '0') + 'T' +
...
export function toClientDateTimeString(date) {
    ...
    return clientDate.getFullYear() + '-' +
        ...
        String(clientDate.getDate()).padStart(2, '0') + 'T' +
...
export function getDateRange(period) {
    ...
    switch (period) {
        ...
        case '3months':
            ...
            const threeMonthsStartStr = threeMonthsStart.getFullYear() + '-' +
        ...
        default:
            ...
            const defaultStartStr = defaultStart.getFullYear() + '-' +
