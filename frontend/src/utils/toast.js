...
class ToastService {
    ...
    getToastClasses(type) {
        const baseClasses = 'transform transition-all duration-300 translate-x-full max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden'
