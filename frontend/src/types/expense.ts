...
export interface ExpenseCreatePayload {
    ...
    medical_expenses?: Array<{
        medical_expense_type: "Consultation" | "Diagnostics Tests" | "Surgery" | "Medicine" | "Therapy" | "Dental" | "Optical" | "Emergency" | "Hospitalization" | "Other"
        amount: number
        date_time: string
        description?: string
...
export function isMedicalExpenseType(obj: any): obj is BackendMedicalExpenseType {
    return obj &&
...
export type MedicalExpenseCategory = typeof MEDICAL_EXPENSE_CATEGORIES[number]['value']
export type OtherExpenseCategory = typeof OTHER_EXPENSE_CATEGORIES[number]['value']
...
export interface DetailedBreakdownData {
    ...
    che_analysis: {
        ...
        che_40: boolean
        che_ratio: number
        risk_level: 'minimal' | 'low' | 'moderate' | 'high' | 'critical' | 'unknown' | 'error'
        risk_score: number
        recommendation: string
        annual_income: number
        annualized_medical: number
        per_capita_income: number
        medical_burden_category: 'minimal_burden' | 'low_burden' | 'moderate_burden' | 'high_burden' | 'extreme_burden' | 'unknown'
        financial_protection_status: 'protected' | 'partially_protected' | 'unprotected' | 'unknown'
        who_che_thresholds: {
        ...
        comparative_analysis: {
            ...
            comparison_status: 'below_average' | 'slightly_above_average' | 'above_average' | 'unknown'
        }
...
export type { Expense as BackendExpense, BackendMedicalExpenseType, BackendExpenseType }