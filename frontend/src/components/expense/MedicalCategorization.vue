	...
	<div class="medical-categorization">
		...
		<div class="flex items-center justify-between mb-6">
			...
			<div class="flex items-center space-x-2">
				<button @click="toggleView" :disabled="!hasData"
				...
				<button @click="exportData" :disabled="!hasData"
					class="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
		...
		<div v-else>
			<!-- Quick Stats Bar -->
			<div
				class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg p-4 mb-6">
			...
			<div v-if="viewMode === 'cards'" class="cards-view">
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
					...
					<CategorySection title="Direct Medical Expenses" :categories="directMedicalCategories"
						:total-amount="directMedicalAmount" color-scheme="blue" icon="stethoscope"
						description="Healthcare services and treatments" @category-selected="selectCategory" />

					<!-- Indirect Medical Categories -->
					<CategorySection title="Indirect Medical Expenses" :categories="indirectMedicalCategories"
						:total-amount="indirectMedicalAmount" color-scheme="purple" icon="car"
			...
			<div v-else class="chart-view">
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
					...
					<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6">
						...
						<div class="h-64">
							<apexchart type="donut" :options="distributionChartOptions"
								:series="distributionChartSeries" height="100%" />
						</div>
					</div>
					...
					<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6">
						...
						<div class="h-64">
							<apexchart type="bar" :options="categoryChartOptions" :series="categoryChartSeries"
								height="100%" />
						</div>
					</div>
				</div>
		...
		<CategoryDetailsModal v-if="selectedCategory" :category="selectedCategory" @close="selectedCategory = null" />
	</div>
</template>
