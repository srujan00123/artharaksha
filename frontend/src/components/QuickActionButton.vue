...
const props = defineProps({
    ...
    color: {
        type: String,
        default: 'blue',
        validator: (value) => ['blue', 'green', 'orange', 'purple', 'indigo', 'pink', 'red', 'yellow', 'gray'].includes(value)
    },
    loading: {
        type: Boolean,
        default: false
...
const buttonClasses = computed(() => {
    ...
    const colorClasses = {
        ...
        green: 'hover:bg-green-50 hover:border-green-200 focus:ring-green-500 text-green-600',
        orange: 'hover:bg-orange-50 hover:border-orange-200 focus:ring-orange-500 text-orange-600',
        purple: 'hover:bg-purple-50 hover:border-purple-200 focus:ring-purple-500 text-purple-600',
        indigo: 'hover:bg-indigo-50 hover:border-indigo-200 focus:ring-indigo-500 text-indigo-600',
        ...
        yellow: 'hover:bg-yellow-50 hover:border-yellow-200 focus:ring-yellow-500 text-yellow-600',
