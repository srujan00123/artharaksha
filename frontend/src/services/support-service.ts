...
export class SupportService {
	...
	async getWelfareSchemes(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.WELFARE_SCHEMES, { filters }),
			)
	...
	async getInsuranceSchemes(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.INSURANCE_SCHEMES, { filters }),
			)
			const schemes = response || []
	...
	async getSupportPathways(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.PATHWAYS, { filters }),
			)
	...
	async getHouseholdProfile(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.HOUSEHOLD_PROFILE),
			)
			...
			if (useCache) {
				cacheService.set(
					SUPPORT_CACHE_KEYS.HOUSEHOLD_PROFILE,
					processedProfile,
					{
						userId: session.user,
						maxAge: CACHE_EXPIRY.HOUSEHOLD_PROFILE,
	...
	async getEligibleSchemes(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.ELIGIBLE_SCHEMES),
			)
	...
	async getSupportRecommendations(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.RECOMMENDATIONS),
			)
	...
	async updateHealthConditions(
		...
		try {
			await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.UPDATE_HEALTH_CONDITIONS, {
	...
	async getSchemeApplications(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.GET_APPLICATIONS),
			)
	...
	async createSchemeApplication(
		...
		try {
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.CREATE_APPLICATION, applicationData),
			)
	...
	async updateSchemeApplication(
		...
		try {
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.UPDATE_APPLICATION, {
	...
	async getSchemeClaims(
		...
		try {
			...
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.GET_CLAIMS),
			)
	...
	async createSchemeClaim(claimData: ClaimFormData): Promise<SchemeClaim> {
		try {
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.CREATE_CLAIM, claimData),
			)
	...
	async updateSchemeClaim(
		...
		try {
			const response = await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.UPDATE_CLAIM, {
					name: claimName,
					...claimData,
				}),
			)
	...
	async deleteSchemeApplication(applicationName: string): Promise<void> {
		try {
			await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.DELETE_APPLICATION, {
					name: applicationName,
				}),
			)
	...
	async deleteSchemeClaim(claimName: string): Promise<void> {
		try {
			await apiService.execute(() =>
				call(API_ENDPOINTS.SUPPORT.DELETE_CLAIM, { name: claimName }),
			)
