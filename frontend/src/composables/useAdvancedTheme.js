...
export function useAdvancedTheme() {
    ...
    const themesByCategory = computed(() => {
        const lightThemes = Object.values(themes).filter(t => t.category === 'light')
        const darkThemes = Object.values(themes).filter(t => t.category === 'dark')
    ...
    const toggleLightDark = () => {
        ...
        const equivalentTheme = Object.values(themes).find(t =>
